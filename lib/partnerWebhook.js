...
function normalizePayment(payment = {}) {
  ...
  return {
    ...
    account_currency: payment.currency || metadata.account_currency || 'RUB',
    amount_currency_minor: metadata.amount_currency_minor ?? payment.amount_minor ?? null,
    effective_currency_rate_rub: metadata.effective_currency_rate_rub ?? payment.currency_rate_rub_snapshot ?? null,
